...
#define CONSTRUCTOR_THEMES_PATH           CCFileUtils::fullPathFromRelativePath( "themes" )
...
inline std::string themePath( const std::string &ii )
{
	return std::string( CONSTRUCTOR_THEMES_PATH ) + string("/") + ii + ".ctz";
}
